...
## Question 2: `volatile` vs `synchronized`?

No answer provided yet.

## Question 3: Why is `volatile` insufficient for counters?

No answer provided yet.

## Question 4: `synchronized` vs `ReentrantLock` — when would you pick the lock?

No answer provided yet.

## Question 5: How do you identify deadlocks in a running application?

No answer provided yet.

## Question 6: What is Synchronization?
