...
### What is differ b/w class and object in java ?
...
### Explain the difer b/w method overloading & method overriding in java ?
...
### What is constructor in java ?A constructor in Java is a special method that is used to initialize objects. It is called when an object of a class is created. It can be used to set initial values for object attributes. Constructors are similar to methods, but they have some important differences:
...
### What is differ b/w default & parameterized constructor in java ?
...
### What is a record and when would you use one over a class?
...
### What is the purpose of iterator interface in java ?
...
### What happens after `javac` compiles a `.java` file — walk through class loading?

No answer provided yet.

### What is the class-loading lifecycle (loading, linking, initialization)?

No answer provided yet.

### How are Spring beans created (lifecycle)?
...
### What are the inheritance not support by java?
